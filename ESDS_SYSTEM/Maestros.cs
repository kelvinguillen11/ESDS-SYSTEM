...
namespace ESDS_SYSTEM
{
    public partial class Maestros : Form
    {
            ...
            try
            {
                if (txtc.Text.Trim() != "" && txtn.Text.Trim() != "" && txta.Text.Trim() != "" && txtce.Text.Trim() != "" && txtu.Text.Trim() != "" && txtcl.Text.Trim() != "")
                {
                    if (email_bien_escrito(txtce.Text))
                    {
                        ...
                        Conection.Conectar();
                        string insertar = "INSERT INTO Maestros(Codigo_maestro, Nombre_maestro, Apellido_maestro, Correo_maestro, Alias_maestro, Clave_maestro) VALUES (@c, @n, @a, @ce, @u, @cl)";
        ...
        private void Maestros_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void PictureBox2_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtc.Text.Trim() != "" && txtn.Text.Trim() != "" && txta.Text.Trim() != "" && txtce.Text.Trim() != "" && txtu.Text.Trim() != "" && txtcl.Text.Trim() != "")
                {
                    ...
                    {
                        Conection.Conectar();
                        string actualizar = "UPDATE Maestros SET Codigo_maestro=@c, Nombre_maestro=@n, Apellido_maestro=@a, Correo_maestro=@ce, Alias_maestro=@u, Clave_maestro=@cl WHERE Codigo_maestro=@c";
        ...
        private void PictureBox3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Conection.Conectar();
                    string eliminar = "DELETE FROM Maestros WHERE Codigo_maestro=@c";
